...
const Home = () => {
  ...
  const { occupied, completed } = useAppSelector(state => state.appData.clock);   
          ...
          <div className="verticalS w-full sm:w-[500px] px-[30px]">
            ...
            {whyHoller && 
              <div className="text-[12px] p-2 text-gray-500">
                Why Holler?? Some browsers block sounds until you interact first, especially if the page is reloaded.
                It's like a little handshake with your browser to make sure session alerts play! Sorry for the little detour!
              </div>
            }
          </div>
        }
