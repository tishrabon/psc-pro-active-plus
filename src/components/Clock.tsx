  ...
  return (
    <div className="mb-[200px]">
      <div className="verticalS gap-5">
              ...
              {!clockData.occupied ? (
                <div className="horizontalBet">
                  <div className="verticalLeft">
                    ...
                    <div className="border-b border-gray-300 pb-1 mb-1 w-full text-left">
                      Loop: {data.pomodoro.sessions}
                    </div>
                ...
                <div className="horizontalBet">
                  <div className="verticalLeft gap-1">
                    ...
                    <div className="pl-2 mt-1">
                      Total: {clockData.sessionsTotal}
                    </div>
                    {!clockData.completed && clockData.sessionsDone !== null ? (
                      <div className="pl-2">
                        Current: {clockData.sessionsDone + 1}
                      </div>
                    ) : null}
                  ...
                  <div className="verticalLeft gap-2">
                    ...
                    <div className="pl-2">
                      {data.pomodoro.focusName}: {clockData.workTime} min
                    </div>
                    <div className="pl-2">
                      {data.pomodoro.breakName}: {clockData.breakTime} min
                    </div>
                    {!clockData.completed ? (
                      <div className="pl-2 horizontalC gap-1">
                        <CiStopwatch size={20} /> <Stopwatch />
                      </div>
                    ) : null}
                    <div className="pl-2">
                      <Volume label="clock" />
        ...
        <div className="text-[18px]">
          {clockData.completed ? (
            ...
            <div className="verticalS gap-3">
              <GrAchievement
                size={36}
                className="text-material text-greent-600"
              />
              <p className="py-1 px-3 bg-material rounded-[5px] text-white">
                Mission Accomplished!
              </p>
              <p className="text-[16px] p-2 rounded-[5px] box-shadow-in2">
                Another brick laid! Each session, a stronger legacy...
              </p>
            </div>
        ...
        <div>
          <div className="bg-material text-white rounded-[50%] w-[110px] h-[110px] grid place-items-center text-[22px]">
            {!clockData.occupied ? (
              <button onClick={() => initiateClock()}>Initiate</button>
            ) : !clockData.completed ? (
              <Timer />
            ) : (
              <button
        ...
        <div
          className={`w-[200px] box-shadow-in p-4 rounded-md horizontalBet px-5 text-[20px]`}
        >
          <LuTimerReset
            title="Reset"
            onClick={() => {
          ...
          {!clockData.occupied ? (
            ...
            <IoPause
              title="Pause"
              onClick={() => {
                !clockData.completed && dispatch(pauseTIME());
              }}
            />
          ) : (
            <IoMdPlay
              title="Resume"
              onClick={() => {
                !clockData.completed && dispatch(resumeTIMER());
              }}
            />
          )}
          <MdRestartAlt
            title="Renew Current Session"
            onClick={() => {
              clockData.occupied &&
                !clockData.completed &&
